...
<body class="home">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        {
                            echo '<li class="nav-item"> <a class="nav-link active" href="index.php">Home <span
                            ...
                            echo '<li class="nav-item"> <a class="nav-link active" href="user_index.php">Home <span
                            class="sr-only">(current)</span></a> </li>
    ...
    <section class="hero bg-image" data-image-src="images/pattern.png">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="banner-text">
                                <h1>
                                    Experience our superfast delivery for fresh food
                                </h1>
                                <p>Peep our menu, make an order and we'll bring it to you asap!</p>
                                <div class="banner-btn mt-4">
                                    <a href="menu.php" class="sec-btn">Check our Menu</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="banner-img-wp">
                                <div>
                                    <img src="images/main_img.png" class="banner-img" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>We've got your covered with menus from a variety of restaurants online.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Choose a dish</h3>
                            <p> Pick your favourite food prepared by the most talented chefs around.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <p>Get your food delivered in no time, And enjoy your meal! </p>
                        </div>
                    </div>
                </div>
            </div>
